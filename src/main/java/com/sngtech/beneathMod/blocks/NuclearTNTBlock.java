...
public class NuclearTNTBlock extends Block
{
	public static final BooleanProperty UNSTABLE = BlockStateProperties.UNSTABLE;

	public NuclearTNTBlock(Block.Properties properties) 
	{
		super(properties);
	 ...
	 */
	public void onExplosionDestroy(World worldIn, BlockPos pos, NuclearExplosion explosionIn) 
	{
		if (!worldIn.isRemote) 
		{
			NuclearTNTEntity tntentity = new NuclearTNTEntity(worldIn, (double)((float)pos.getX() + 0.5F), (double)pos.getY(), (double)((float)pos.getZ() + 0.5F), explosionIn.getExplosivePlacedBy());
	...
	private static void explode(World p_196535_0_, BlockPos p_196535_1_, @Nullable LivingEntity p_196535_2_) 
	{
		...
		{
			NuclearTNTEntity tntentity = new NuclearTNTEntity(p_196535_0_, (double)((float)p_196535_1_.getX() + 0.5F), (double)p_196535_1_.getY(), (double)((float)p_196535_1_.getZ() + 0.5F), p_196535_2_);
    ...
    */
   public boolean canDropFromExplosion(NuclearExplosion explosionIn) 
   {
      return false;
   }
