...
public class AMChunkGenerator extends NoiseChunkGenerator<AMGenSettings>
{
	...
	public AMChunkGenerator(IWorld world, BiomeProvider provider, AMGenSettings settingsIn) 
	{
