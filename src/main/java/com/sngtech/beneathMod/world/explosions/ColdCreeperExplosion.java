package com.sngtech.beneathMod.world.explosions;
...
public class ColdCreeperExplosion extends Explosion
{
   private final ColdCreeperExplosion.Mode mode;
   ...
   @OnlyIn(Dist.CLIENT)
   public ColdCreeperExplosion(World worldIn, @Nullable Entity entityIn, double x, double y, double z, float size, List<BlockPos> affectedPositions) 
   {
      this(worldIn, entityIn, x, y, z, size, ColdCreeperExplosion.Mode.DESTROY, affectedPositions);
   }

   @OnlyIn(Dist.CLIENT)
   public ColdCreeperExplosion(World p_i50006_1_, @Nullable Entity p_i50006_2_, double p_i50006_3_, double p_i50006_5_, double p_i50006_7_, float p_i50006_9_, ColdCreeperExplosion.Mode p_i50006_11_, List<BlockPos> p_i50006_12_) 
   {
      this(p_i50006_1_, p_i50006_2_, p_i50006_3_, p_i50006_5_, p_i50006_7_, p_i50006_9_, p_i50006_11_);
      ColdCreeperExplosion.affectedBlockPositions.addAll(p_i50006_12_);
   }

   public ColdCreeperExplosion(World p_i50007_1_, @Nullable Entity p_i50007_2_, double p_i50007_3_, double p_i50007_5_, double p_i50007_7_, float p_i50007_9_, ColdCreeperExplosion.Mode p_i50007_11_) 
   {
	  super(p_i50007_1_, p_i50007_2_, p_i50007_3_, p_i50007_5_, p_i50007_7_, p_i50007_9_, affectedBlockPositions);
   ...
   public void doExplosionA() {
      ...
      ColdCreeperExplosion.affectedBlockPositions.addAll(set);
   ...
   public void doExplosionB(boolean spawnParticles) {
      ...
      boolean flag = this.mode != ColdCreeperExplosion.Mode.NONE;
      ...
      if (flag) {
         for(BlockPos blockpos : ColdCreeperExplosion.affectedBlockPositions) 
         {
            BlockState blockstate = this.world.getBlockState(blockpos);
            ...
            if (!blockstate.isAir(this.world, blockpos)) 
            {
               if (this.world instanceof ServerWorld && blockstate.canDropFromExplosion(this.world, blockpos, this)) 
               {
                  ...
                  if (this.mode == ColdCreeperExplosion.Mode.DESTROY) 
                  {
   ...
   public void clearAffectedBlockPositions() {
      ColdCreeperExplosion.affectedBlockPositions.clear();
   }

   public List<BlockPos> getAffectedBlockPositions() {
      return ColdCreeperExplosion.affectedBlockPositions;
   }
