...
{
   private final NuclearExplosion.Mode mode;
   ...
   @OnlyIn(Dist.CLIENT)
   public NuclearExplosion(World worldIn, @Nullable Entity entityIn, double x, double y, double z, float size, List<BlockPos> affectedPositions) 
   {
      this(worldIn, entityIn, x, y, z, size, NuclearExplosion.Mode.DESTROY, affectedPositions);
   }

   @OnlyIn(Dist.CLIENT)
   public NuclearExplosion(World p_i50006_1_, @Nullable Entity p_i50006_2_, double p_i50006_3_, double p_i50006_5_, double p_i50006_7_, float p_i50006_9_, NuclearExplosion.Mode p_i50006_11_, List<BlockPos> p_i50006_12_) 
   {
      this(p_i50006_1_, p_i50006_2_, p_i50006_3_, p_i50006_5_, p_i50006_7_, p_i50006_9_, p_i50006_11_);
      NuclearExplosion.affectedBlockPositions.addAll(p_i50006_12_);
   }

   public NuclearExplosion(World p_i50007_1_, @Nullable Entity p_i50007_2_, double p_i50007_3_, double p_i50007_5_, double p_i50007_7_, float p_i50007_9_, NuclearExplosion.Mode p_i50007_11_) 
   {
   ...
   public void doExplosionB(boolean spawnParticles) {
      ...
      boolean flag = this.mode != NuclearExplosion.Mode.NONE;
      ...
      if (flag) {
         for(BlockPos blockpos : NuclearExplosion.affectedBlockPositions) 
         {
            BlockState blockstate = this.world.getBlockState(blockpos);
            ...
            if (!blockstate.isAir(this.world, blockpos)) 
            {
               if (this.world instanceof ServerWorld && blockstate.canDropFromExplosion(this.world, blockpos, this)) 
               {
                 ...
                 // LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withRandom(this.world.rand).withParameter(LootParameters.POSITION, blockpos).withParameter(LootParameters.TOOL, ItemStack.EMPTY).withNullableParameter(LootParameters.BLOCK_ENTITY, tileentity);
                  //if (this.mode == NuclearExplosion.Mode.DESTROY) 
                 // {
   ...
   public void clearAffectedBlockPositions() {
      NuclearExplosion.affectedBlockPositions.clear();
   }

   public List<BlockPos> getAffectedBlockPositions() {
      return NuclearExplosion.affectedBlockPositions;
   }
