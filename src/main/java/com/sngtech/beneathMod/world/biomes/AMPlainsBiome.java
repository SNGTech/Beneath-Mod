...
public class AMPlainsBiome extends Biome
{
	...
	public AMPlainsBiome() 
	{
		...
		//this.addFeature(Decoration.LOCAL_MODIFICATIONS, createDecoratedFeature(ModFeatures.TEST, IFeatureConfig.NO_FEATURE_CONFIG, Placement.CHANCE_PASSTHROUGH, new ChanceConfig(60)));
		this.addFeature(Decoration.LOCAL_MODIFICATIONS, createDecoratedFeature(Feature.PILLAGER_OUTPOST, new PillagerOutpostConfig(0.004D), Placement.CHANCE_PASSTHROUGH, new ChanceConfig(60)));
