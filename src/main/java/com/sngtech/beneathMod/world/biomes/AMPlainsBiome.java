...
public class AMPlainsBiome extends Biome
{
	...
	public AMPlainsBiome() 
	{
		...
		this.addFeature(Decoration.SURFACE_STRUCTURES, createDecoratedFeature(ModFeatures.TEST, IFeatureConfig.NO_FEATURE_CONFIG, Placement.CHANCE_PASSTHROUGH, new ChanceConfig(80)));
